...
CREATE TABLE `betorder` (
  ...
  `stake_token` int(255) NOT NULL,
  `racetrack_id` int(5) NOT NULL,
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `iteration` int(255) NOT NULL,
...
CREATE TABLE `game` (
  ...
  `user_count` int(255) NOT NULL,
  `racetrack_row` int(255) NOT NULL,
...
CREATE TABLE `racetrack` (
  `racetrack_id` int(5) NOT NULL,
  `stake_token` int(255) unsigned zerofill NOT NULL,
...
CREATE TABLE `user` (
  ...
  `balance` int(255) unsigned zerofill NOT NULL,
...
CREATE TABLE `withdraw` (
  ...
  `amount_token` double(255,2) NOT NULL,
  `amount_eos` double(255,2) NOT NULL,
  `if_done` int(1) unsigned zerofill NOT NULL,
